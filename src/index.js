...
function generateFact(event) {
  ...
  let context =
    "You are a knowledgeable AI assistant that can provide intriguing short facts. Your misson is to provide a fact in basic HTML, which is no longer than 8 lines. Do not include a title. Make sure to follow user instructions.";
